...
if __name__ == '__main__':
    ...
    #load_data('questions.txt', 'answers.txt', MAX_LEN, VOCAB_SIZE)
    X, X_vocab_len, X_word_to_ix, X_ix_to_word, y, y_vocab_len, y_word_to_ix, y_ix_to_word = load_data('questions.txt', 'answers.txt', MAX_LEN, VOCAB_SIZE)
    ...
    if MODE == 'train':
        ...
        for k in range(k_start, NB_EPOCH+1):
            ...
            for i in range(0, len(X), 1000):
                ...
                model.fit(X[i:i_end], y_sequences, batch_size=BATCH_SIZE, nb_epoch=1, verbose=2, callbacks=[csv_logger])
